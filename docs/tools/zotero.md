---
title: Zotero 与论文阅读
description: 用于论文翻译、中文文献、阅读管理和附件整理的 Zotero 插件。
---

# Zotero 与论文阅读

按使用场景整理的 Zotero 插件。安装方式与兼容版本可在各项目说明中查看。
...
[Zotero 中文社区插件商店](https://zotero-chinese.com/plugins/#tags=favorite)汇总了插件入口、下载和使用说明。
